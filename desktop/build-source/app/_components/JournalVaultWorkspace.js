...
import { downloadJson, exportContinuityInsightReport, sanitizeFilename } from "./product-local-files";
      ...
      return {
        ...
        summary:
          delta === 0 && criticalDelta === 0
            ? "Flat vs comparison"
            : `${delta > 0 ? "+" : ""}${delta} drifts | ${criticalDelta > 0 ? "+" : ""}${criticalDelta} critical`
      };
    })
    .sort(
      (left, right) =>
