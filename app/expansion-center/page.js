    ...
    <main style={{minHeight:"100vh",background:"linear-gradient(180deg,#020617 0%,#0b1120 100%)",color:"white",padding:24,fontFamily:"Arial,sans-serif"}}>
      <div style={{maxWidth:1600,margin:"0 auto",display:"grid",gap:20}}>
        <div style={card}>
          ...
          <h1 style={{fontSize:42,margin:"10px 0 0"}}>Expansion Center</h1>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(5,minmax(0,1fr))",gap:16}}>
          <div style={card}><div style={{color:"#94a3b8",fontSize:12}}>Desktop</div><div style={{fontSize:28,fontWeight:900,marginTop:6}}>{data.domains.desktop}%</div></div>
          <div style={card}><div style={{color:"#94a3b8",fontSize:12}}>Mobile</div><div style={{fontSize:28,fontWeight:900,marginTop:6}}>{data.domains.mobile}%</div></div>
