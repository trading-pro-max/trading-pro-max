...
function tradingChecks() {
  return [
    ...
    { key: "trading_workflow", label: "Trading workflow", weight: 1, pass: exists("ops/workflows/trading-core.yml") }
  ];
}
...
function productChecks() {
  return [
    ...
    { key: "surface_component", label: "Surface component", weight: 1, pass: exists("app/_components/SurfacePage.js") },
    { key: "product_docs", label: "Product surface docs", weight: 1, pass: exists("docs/PRODUCT_SURFACE.md") }
  ];
}
...
function launchChecks() {
  return [
    ...
    { key: "security_workflow", label: "Security workflow", weight: 1, pass: exists("ops/workflows/security.yml") && exists("ops/workflows/launch-readiness.yml") },
    { key: "super_layer", label: "Super control layer", weight: 1, pass: exists("lib/tpm-super-orchestrator.mjs") && exists("app/super-control/page.js") && exists("app/api/super/status/route.js") && exists("app/api/super/run/route.js") }
  ];
}
