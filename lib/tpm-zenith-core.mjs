...
export function runZenithCycle(){
  const zenithSignals = [
    exists("app/zenith-core/page.js"),
    exists("app/api/zenith/status/route.js"),
    exists("app/api/zenith/run/route.js"),
    exists("lib/tpm-zenith-core.mjs"),
    exists("scripts/tpm-zenith-loop.mjs"),
    exists("data/zenith/runtime.json")
  ];

  const cartographySignals = [
    exists("app/memory-cartography/page.js"),
    exists("data/zenith/memory-cartography.json"),
  ...
  const charterSignals = [
    exists("app/runtime-charter/page.js"),
    exists("data/zenith/runtime-charter.json"),
